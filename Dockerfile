# RabbitMQ DOCKER FILE WITH ALL PLUGINS
# includes management, MQTT, MQTT w/ Web socket support
# clustering, shovel, STOMP and STOMP



FROM rabbitmq:3.7-management

# set the admin & api users
...
# enable High-Performance Erlang
